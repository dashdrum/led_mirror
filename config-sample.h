...
#define CONFIG_PUSHBUTTON_PIN D8 // For pushbutton pin - use a pulled down pin if available

// OTA
#define CONFIG_OTA_HOST "{UniqueHostName}"
#define CONFIG_OTA_PATH "/WebFirmwareUpgrade"
#define CONFIG_OTA_USER "{OTA-USERNAME}"
...
// MQTT Topics
#define CONFIG_MQTT_TOPIC_STATE "YourDevice/state"
#define CONFIG_MQTT_TOPIC_SET "YourDevice/set"
...
// Color Adjust for LED sets
// 255 means no adjustment, 0 means don't show the color
// Defaults from FastLED for 5050
#define CONFIG_RED_ADJUST   255
#define CONFIG_GREEN_ADJUST 176
#define CONFIG_BLUE_ADJUST  240
...
#define CONFIG_BUILTIN_LED_ON LOW       // On is LOW for Wemos D1 Mini
#define CONFIG_BUILTIN_LED_OFF HIGH     // Off is HIGH for Wemos D1 Mini
